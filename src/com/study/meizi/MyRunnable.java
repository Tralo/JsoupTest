...
public class MyRunnable implements Runnable{
    ...
    private void init(){
        ...
        header.put("User-Agent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3355.4 Safari/537.36");  
        header.put("Accept", "image/webp,image/apng,image/*,*/*;q=0.8");
    }
	public MyRunnable(MeiItem item) {
		this.item = item;
